 ...
 */
public class DocumentInjectorThread implements Runnable {
    /**
    ...
    /**
     * Header object of the document to be injected
     */
    private DocHeader headerObj;
     ...
     */
    public DocumentInjectorThread(int windowId, int menuId, DocHeader headerObj) {
     ...
     * {@link DocumentInjectorThread} calling this method is guaranteed to get a different
     * window number
     * 
